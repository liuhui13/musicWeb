        ...
        <div class="album-content">
            ...
            <div class="album-score">
                ...
                <div>
                    <h3>评价：</h3>
                    <div @click="setGrade">
                        <el-rate v-model="grade" allow-half show-text></el-rate>
                    </div>                    
                </div>
            </div>
...
import {listSongDetail,songOfSongId,setGrade,getGradeOfSongListId} from '../api/index';
    ...
    methods:{
        ...
        setGrade(){
            if(this.loginIn){
                ...
                params.append('score',this.grade *2);
                setGrade(params)
                    .then(res => {
                        if(res.code == 1){
